...
"""
    ...
    ctx.add_transforms(
        ...
        transforms_from(
"""
addon-install-from-file-dialog-title = { COPY(from_path, "installFromFile.dialogTitle", trim:"True")}
addon-install-from-file-filter-name = { COPY(from_path, "installFromFile.filterName", trim:"True")}
extension-heading = { COPY(from_path, "listHeading.extension", trim:"True")}
theme-heading = { COPY(from_path, "listHeading.theme", trim:"True")}
plugin-heading = { COPY(from_path, "listHeading.plugin", trim:"True")}
dictionary-heading = { COPY(from_path, "listHeading.dictionary", trim:"True")}
locale-heading = { COPY(from_path, "listHeading.locale", trim:"True")}
shortcuts-heading = { COPY(from_path, "listHeading.shortcuts", trim:"True")}
theme-heading-search-label = { COPY(from_path, "searchLabel.theme", trim:"True")}
extension-heading-search-label = { COPY(from_path, "searchLabel.extension", trim:"True")}
"""
